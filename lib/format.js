...
export function buildWhatsAppBuyNowUrl(product) {
  ...
  const message = `Hi The Dial Edit! I'd like to buy the ${product.brand} ${product.name} (${formatINR(product.price)}). Please confirm availability and delivery details.`;
